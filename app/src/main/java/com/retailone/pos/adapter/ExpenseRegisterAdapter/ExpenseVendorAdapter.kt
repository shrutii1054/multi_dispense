...
class ExpenseVendorAdapter(
    context: Context,
    resource: Int,
    objects: List<ExpenseVendorData>
) : ArrayAdapter<ExpenseVendorData>(context, resource, objects) {
    ...
    private fun initView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val currentItem: ExpenseVendorData? = getItem(position)

        binding.adapterText.text = currentItem?.vendor_name
